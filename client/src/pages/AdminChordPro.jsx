    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {(vistaCancion || loadingVista) && (
        <div className="fixed inset-0 bg-white z-[60] flex flex-col">
          {/* Barra superior */}
          <div className="flex-shrink-0 bg-white flex items-center gap-3 px-4 py-3 border-b border-gray-100 shadow-sm">
            <button
              onClick={() => { setVistaCancion(null); setSemitonos(0); }}
              className="p-2 rounded-xl text-gray-400 hover:bg-gray-100 transition flex-shrink-0"
            >
              <ArrowLeft size={22} />
            </button>
            ...
            <div className="flex items-center gap-1 bg-gray-100 rounded-xl px-2 py-1.5 flex-shrink-0">
              <button onClick={() => setSemitonos(s => s - 1)} className="p-2 rounded-lg hover:bg-white transition text-gray-600" title="Bajar semitono">
                <ChevronDown size={18} />
              </button>
              ...
              <button onClick={() => setSemitonos(s => s + 1)} className="p-2 rounded-lg hover:bg-white transition text-gray-600" title="Subir semitono">
                <ChevronUp size={18} />
              </button>
              {semitonos !== 0 && (
                <button onClick={() => setSemitonos(0)} className="p-1.5 rounded-lg hover:bg-white transition text-gray-400" title="Restablecer">
                  <X size={14} />
                </button>
              )}
            </div>
            ...
            {vistaCancion && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-violet-600 hover:bg-violet-700 text-white text-sm font-semibold rounded-xl transition flex-shrink-0"
              >
